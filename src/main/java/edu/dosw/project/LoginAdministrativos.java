...
public class LoginAdministrativos extends JFrame {
    // Panel centrado con fondo gris claro y card blanco, igual que en PantallaSeleccionRol
    ...
    public LoginAdministrativos() {
        setTitle("Login Administrativos");
        ...
        // Título
        JLabel title = new JLabel("Ingreso Administrativos");
        ...
        ingresarBtn.addActionListener(e -> JOptionPane.showMessageDialog(this, "Bienvenido, administrativo!", "Login Exitoso", JOptionPane.INFORMATION_MESSAGE));
